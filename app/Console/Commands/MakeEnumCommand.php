...
class MakeEnumCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $namespace = 'App\Enums'; // Base namespace
        $path = app_path('Enums');
        ...
        $this->createEnumFile($filePath, $namespace, $className); // Pass $parts

        $filePath = str_replace('//', '\\', $filePath);
        $this->info("Enum class {$filePath} created successfully.");
     ...
     * @return void
     */
    protected function createEnumFile($filePath, $namespace, $className)
    {
