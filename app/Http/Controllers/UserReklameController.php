...
class UserReklameController extends Controller
{
    ...
    public function store(Request $request, $nomor_registrasi)
    {
        ...
        return redirect()->route('public.permohonan.show', $permohonan->id)->with('success', 'Data Reklame berhasil diajukan. Silahkan lengkapi berkas permohonan pada setiap reklame');
    }
