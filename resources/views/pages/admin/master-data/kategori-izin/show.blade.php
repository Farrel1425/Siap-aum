            ...
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last d-flex align-items-center">
                    <h3 class="d-inline mb-0">
                        ...
                        </a> Edit Kategori Ijin
                    </h3>
                </div>
            </div>
        </div>
        <section class="section">
            <form action="{{ route('admin.master-data.kategori-izin.update', $kategori_izin->id) }}"
                ...
                <div class="card mb-3">
                    <div class="card-body p-3">
                        <x-dashboard.input-inline-text :required=True
                                                       ...
                                                       label="Nama"
                                                       name="nama"
                                                       placeholder="Masukkan nama layanan skm"
                                                       value="{{ old('nama', $kategori_izin->nama) }}" />
                    </div>
                </div>
