...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            @if (old('pertanyaan'))
                @foreach (old('pertanyaan') as $key => $pertanyaan)
                    addPertanyaan("{{ $pertanyaan['pertanyaan'] }}", "{{ $pertanyaan['pilihan_jawaban_1'] }}",
                        "{{ $pertanyaan['pilihan_jawaban_2'] }}", "{{ $pertanyaan['pilihan_jawaban_3'] }}",
                        "{{ $pertanyaan['pilihan_jawaban_4'] }}");
                @endforeach
            @endif
        });
